...
navbarPage(
  ...
  tabPanel('Downloads', "Complete canSynergise datasets are available for download here.", br(), h3("canSynergise cell lines"),br(), a("canSynergise cell lines", href="https://cansarblack.icr.ac.uk/", target="_blank"), br(), a("canSynergise cell line read me", href="https://cansarblack.icr.ac.uk/", target="_blank"), br(), h3("canSynergise trials"), br(), a("canSynergise trials", href="https://cansarblack.icr.ac.uk/", target="_blank"), br(), a("canSynergise trials read me", href="https://cansarblack.icr.ac.uk/", target="_blank"), br(), h3("Past versions")),
  fluid=TRUE
)
